...
These **public skills** help you convert interfaces, debug models, build form schemas, migrate legacy code, review security, and more. If you are a QuickModel contributor, see [Internal Skills →](../internal/skills) for TDD, lint/typecheck, SOLID, and documentation sync workflows.
...
2. Generates the QModel class with correct `@Quick({ fileMode })` decorators for Blob/File fields
