...
Los skills existen en dos grupos:

- **Skills públicos** — para desarrolladores que usan QuickModel en sus proyectos. Ayudan a convertir interfaces, depurar modelos, construir schemas de formularios, migrar código legado, revisar seguridad y más.
- **Skills de mantenimiento** — para contribuidores que trabajan en el código base de QuickModel. Aplican TDD, puertas de lint/typecheck, diseño SOLID y sincronización de documentación.
...
> Para **contribuidores** que trabajan en el código base de QuickModel. Estos skills usan las [Herramientas Internas](../internal/) y aplican las reglas del proyecto automáticamente.
