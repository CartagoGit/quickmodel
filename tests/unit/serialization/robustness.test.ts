...
describe('Robustness Scenarios', () => {
    ...
    describe('Circular References', () => {
        test('should handle circular references in plain objects', () => {
            interface ICircular { self: any }
            @Quick()
            class Circular extends QModel<ICircular> { declare self: any; }
        ...
        test('should handle circular references in Arrays', () => {
            interface ICircularArray { list: any[] }
            @Quick()
            class CircularArray extends QModel<ICircularArray> { declare list: any[]; }
        ...
        test('should handle circular references in Maps', () => {
             interface ICircularMap { map: Map<string, any> }
             @Quick({ map: Map })
             class CircularMap extends QModel<ICircularMap> { declare map: Map<string, any>; }
    ...
    describe('Deep Recursive Serialization', () => {
        test('should serialize BigInt inside Map', () => {
            interface IComplex { map: Map<string, bigint> }
            @Quick({ map: Map })
            class Complex extends QModel<IComplex> { declare map: Map<string, bigint>; }
        ...
        test('should serialize Date inside Set', () => {
             interface IComplex { dates: Set<Date> }
             @Quick({ dates: Set })
             class Complex extends QModel<IComplex> { declare dates: Set<Date>; }
